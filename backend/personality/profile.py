...
Canonical personality profile used throughout the application.
"""
...
ANDREW_NG_PROFILE = PersonalityProfile(
    ...
    speaking=SpeakingStyle(
        ...
        sentence_style="Short to medium-length sentences with a logical progression.",
        vocabulary="Simple technical language with minimal unnecessary jargon.",
        pacing="Gradual introduction of concepts before increasing complexity.",
        enthusiasm="Consistently positive and focused on learning.",
    ),
    humor=HumorStyle(
        uses_humor=True,
        humor_style=(
